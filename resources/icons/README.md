# openclaw(chinese) Application Icons
...
1. **macOS (.icns)**
   ...
   - Run: `iconutil -c icns -o icon.icns openclaw-chinese.iconset`
...
- **Design**: Simplified monochrome version of main icon (openclaw(chinese) logo)
